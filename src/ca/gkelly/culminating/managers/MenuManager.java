...
public class MenuManager extends UIManager {
	...
	protected void init() {
		...
		showInst = new UIButton(new UIPosition(0, -150, UIPosition.CENTRE, UIPosition.BOTTOM), "Instructions",
				titleFont);
		addChild(showInst);
		...
		instructions = new UIContainer(new UIPosition(0, 0, UIPosition.CENTRE, UIPosition.CENTRE),
				new UIDimensions(new UISet(5), 300, 250), Color.white);
		instructions.setBorder(new UIBorder(5, Color.BLACK));
		instructions.setVisible(false);

		instructions.addChild(
				new UIText(new UIPosition(0, 10, UIPosition.CENTRE, UIPosition.TOP), "Instructions", subFont));
		instructions.addChild(
				new UIText(new UIPosition(0, 90, UIPosition.CENTRE, UIPosition.TOP), "Use WASD to move", subFont));
		instructions.addChild(
				new UIText(new UIPosition(0, 130, UIPosition.CENTRE, UIPosition.TOP), "Click to shoot", subFont));
