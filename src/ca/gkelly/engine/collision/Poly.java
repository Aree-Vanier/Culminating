...
/**
 * Class used to handle polygon shapes <br/>
 * Mostly used to separate basic poly code from collision functions
 */
public class Poly {
	...
	/**
	 * Create the polygon with the passed vertices
	 * 
	...
	/** Get the {@link java.awt.Polygon} with the same vertices */
	...
	/** Get the string representation of the vertices */
